    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            '${'duration'.tr()}: ${current?.duration ?? ''}',
            style: const TextStyle(fontSize: 13),
          ),
          Text(
            '${'distance'.tr()}: ${current?.distanceString ?? ''}',
            style: const TextStyle(fontSize: 13),
          ),
              ...
              itemBuilder: (context, index) {
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '${'species_title'.tr()}: ${current?.markers?[index].records?.length} '
