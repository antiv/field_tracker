import 'package:tracker_core/widgets/transect_info.dart';
import 'package:tracker_core/widgets/transects_history.dart';
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'about_description'.tr(namedArgs: appArgs),
              ...
              children: [
                ...
                ExpansionTile(
                  ...
                  children: <Widget>[
                    ...
                    /// the app's own entries — the surveyor's details, say
                    for (final item in TrackerConfig.current.extraMenuItems)
                      ListTile(
