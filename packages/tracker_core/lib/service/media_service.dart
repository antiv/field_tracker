...
/// user-visible copy in the app's gallery album. Records persist the
...
class MediaService {
  ...
  String _newName() {
    ...
    return '${TrackerConfig.current.photoPrefix}_${stamp}_$suffix.jpg';
  }
  ...
  Future<void> _addToGallery(String path) async {
    final album = TrackerConfig.current.galleryAlbum;
    try {
