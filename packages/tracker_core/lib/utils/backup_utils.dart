...
/// The records file inside the backup archive, named after the app.
String get kBackupJsonName => '${TrackerConfig.current.backupBaseName}.json';
...
class BackupUtils {
  ...
  static Future<String> read(String archivePath) async {
    ...
    if (json == null) {
      throw FormatException('Backup archive has no $kBackupJsonName');
    }
    return json;
  }
}
