...
import 'package:tracker_core/service/media_service.dart';
import 'package:tracker_core/service/sembast_service.dart';
import 'package:tracker_core/utils/kml_utils.dart';
import 'package:tracker_core/utils/kmz_utils.dart';
...
/// `{app}` in a translated text is the app's name.
Map<String, String> get appArgs => {'app': TrackerConfig.current.appTitle};
  ...
  try {
    ...
    await SharePlus.instance.share(
      ShareParams(
        ...
        text: 'backup_text'.tr(namedArgs: appArgs),
