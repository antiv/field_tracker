...
#   4) app sa bundle ID-em rs.antonijevic.ciconiaTracker mora postojati u App Store
...
<dict>
  ...
  <dict>
    <key>rs.antonijevic.ciconiaTracker</key><string>CiconiaTracker AppStore</string>
  </dict>
