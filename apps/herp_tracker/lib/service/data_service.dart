...
class DataService with ChangeNotifier {
  ...
  void setLastLocalityPreference(String locality) {
    prefs?.setString('last_locality', locality);
  }

  String? getLastLocalityPreference() {
    return prefs?.getString('last_locality');
  }
